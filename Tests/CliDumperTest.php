...
%A  options: []
  ...
  "obj" => VarTrumper\Tests\Fixture\DumbFoo {#%d
    +foo: "foo"
    +"bar": "bar"
  }
  "closure" => Closure {{$r}
    class: "VarTrumper\Tests\CliDumperTest"
    this: VarTrumper\Tests\CliDumperTest {{$r} …}
    parameters: {
      \$a: {}
      &\$b: {
        typeHint: "PDO"
  ...
  8 => &1 null
  "sobj" => VarTrumper\Tests\Fixture\DumbFoo {#%d}
  "snobj" => &3 {#%d}
  "snobj2" => {#%d}
  "file" => "{$var['file']}"
  b"bin-key-é" => ""
...
EOTXT
    ...
    public function testThrowingCaster()
    {
        ...
        $this->assertStringMatchesFormat(
            <<<EOTXT
stream resource {@{$ref}
  ⚠: VarTrumper\Exception\ThrowingCasterException {{$r}
