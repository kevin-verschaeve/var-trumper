...
%A  <span class=sf-dump-meta>options</span>: []
  ...
  "<span class=sf-dump-key>obj</span>" => <abbr title="VarTrumper\Tests\Fixture\DumbFoo" class=sf-dump-note>DumbFoo</abbr> {<a class=sf-dump-ref href=#{$dumpId}-ref2%d title="2 occurrences">#%d</a><samp id={$dumpId}-ref2%d>
  ...
  "<span class=sf-dump-key>closure</span>" => <span class=sf-dump-note>Closure</span> {{$r}<samp>
    <span class=sf-dump-meta>class</span>: "<span class=sf-dump-str title="VarTrumper\Tests\HtmlDumperTest
48 characters"><span class=sf-dump-ellipsis>VarTrumper\Tests</span>\HtmlDumperTest</span>"
    <span class=sf-dump-meta>this</span>: <abbr title="VarTrumper\Tests\HtmlDumperTest" class=sf-dump-note>HtmlDumperTest</abbr> {{$r} &%s;}
...
%d characters"><span class=sf-dump-ellipsis>%sTests</span>%eFixtures%edumb-var.php</span>"
  ...
  "<span class=sf-dump-key>sobj</span>" => <abbr title="VarTrumper\Tests\Fixture\DumbFoo" class=sf-dump-note>DumbFoo</abbr> {<a class=sf-dump-ref href=#{$dumpId}-ref2%d title="2 occurrences">#%d</a>}
